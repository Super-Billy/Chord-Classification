...
def train_rnn(args: argparse.Namespace):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        val_f1_w = f1_score(all_targets, all_preds, average="weighted", zero_division=0)
        scheduler.step()
        print(f"Epoch {epoch:02d}  val_acc={val_acc:.3f}  f1_macro={val_f1:.3f}  f1_weighted={val_f1_w:.3f}")
